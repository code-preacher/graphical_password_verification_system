      ...
      <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav">
                        ...
                        <li class="active">
                              <a href="#">GRAPHICAL PASSWORD AUTHENTICATION SYSTEM</a>
                        </li>
                      <!--   <li>
...
<div class="signupform">
	<div class="container">
		<div class="agile_info">
			...
			<?php 
                  $images=array('..\images\pw\image1.jpg','..\images\pw\image2.jpg','..\images\pw\image3.jpg','..\images\pw\image4.jpg','..\images\pw\image5.jpg');
                  shuffle($images);
                  ?>
                  <div class="login_info">
                        ...
                        <img class="im" src="<?=$image?>" onclick="changeIt(this)" height="120" width="120">
                              <?php } ?>
                        </center>
			</div>
		</div>
...
<!--footer-main-->
 ...
 <center><span style="color: #fff;font-family: tahoma;">This software was developed by Ekpong Justina Moshi and Supervised By Mr.Idoko Charles Onyeke</span></center>
